...
const forgotpassword = async (req, res) => {
    try {
        ...
        if(user){
            // const id = uuid.v4();
            const id = await Forgotpassword.create({ active: true, userId: user._id})
            // console.log(id._id);
            ...
            const msg = {
                ...
                html: `<a href="${url}:3000/password/resetpassword/${id._id}">Reset password</a>`,
            }
            console.log(id._id);
            sgMail
            .send(msg)
    ...
    try {
        ...
        console.log(forgotpasswordrequest)
         if(forgotpasswordrequest){
            await forgotpasswordrequest.updateOne({ active: false, userId: forgotpasswordrequest.userId});
